...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
% Do not count pages until after the FirstPage
...
%  First page
% ----------------------------------------------------------------------
\input{Thesis_FirstPage} % file "Thesis_FirstPage.tex"
\cleardoublepage
...
\input{/home/guimas/Documents/Chapters/edgeanddiv/Chapters/edgeanddivertor.tex}
\cleardoublepage

\chapter{Reflectometry measurement technique and signal analysis}
\label{chapter:reflectometry}
\input{/home/guimas/Documents/Chapters/reflectometry/Chapters/reflectometry.tex}
\input{/home/guimas/Documents/Chapters/reflectometry/Chapters/analysis.tex}
\input{/home/guimas/Documents/Chapters/reflectometry/Chapters/diagnostics.tex}
\cleardoublepage

\chapter{Evolution of density profiles in L-mode}
\label{chapter:lmode}
\input{/home/guimas/Documents/Chapters/lmode/Chapters/L-mode.tex}
\cleardoublepage

\chapter{Evolution of density profiles in H-mode}
\label{chapter:hmode}
\input{/home/guimas/Documents/Chapters/hmode/Chapters/H-mode.tex}
\cleardoublepage

\chapter{Effect of the magnetic configuration on the HFS density profiles}
\label{chapter:magconf}
\input{/home/guimas/Documents/Chapters/magconf/Chapters/Magconf.tex}
\cleardoublepage

\chapter{Summary and future prospects}
\label{chapter:summaryandconclusions}
\input{/home/guimas/Documents/Chapters/Summary/Chapters/summary.tex}
\cleardoublepage
